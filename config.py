...
BOT_USERNAME = getenv("BOT_USERNAME", "RiZoeLXMusic_Bot")
ASSISTANT_NAME = getenv("ASSISTANT_NAME", "RiZoeL_VC")
GROUP_SUPPORT = getenv("GROUP_SUPPORT", "DNHxHELL")
UPDATES_CHANNEL = getenv("UPDATES_CHANNEL", "DragNeelOP")
OWNER_NAME = getenv("OWNER_NAME", "TheRiZoeL") # isi dengan username kamu tanpa simbol @
