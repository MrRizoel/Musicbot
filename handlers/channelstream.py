    ...
    if audio:
        ...
        keyboard = InlineKeyboardMarkup(
            [
                ...
                [InlineKeyboardButton(text="ʀɪᴢᴏᴇʟ", url=f"https://t.me/TheRiZoeL")],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/e5c6c4a4e249c60b8c8a5.jpg"
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("ʀɪᴢᴏᴇʟ", url=f"https://t.me/TheRiZoeL")
                ]
            ]
        )
        requested_by = message.from_user.first_name
